    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pix', models.ImageField(max_length=500, upload_to=getch.models._profilepix_path)),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('eye_mask', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='eye', to='getch.Mask')),
                ('mouth_mask', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='mouth', to='getch.Mask')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='mask',
            name='maskbase',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='getch.MaskBase'),
        ),
        migrations.AddField(
            model_name='boo',
            name='profile',
